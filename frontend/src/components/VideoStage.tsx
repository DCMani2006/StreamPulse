...
const PRESET_SCENARIOS: PresetScenario[] = [
  {
    id: 'traffic',
    title: 'Traffic & Highway Corridor',
    subtitle: 'High-Impact Vehicle Collisions & Skids',
    description: 'Kinematic tracking detecting vehicle convergence, sudden deceleration (Δv ≥ 70%), and traffic impacts.',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4',
    zone: [0.0, 0.0, 1.0, 1.0],
    tags: ['TRAFFIC', 'Vehicle Collision', 'Impact Transients'],
  },
  {
    id: 'industrial_safety',
    title: 'Smart Warehouse & Logistics',
    subtitle: 'Restricted Hazard Zone & Machinery Breach',
    description: 'Autonomous safety monitoring detecting worker proximity, restricted bay breaches, and missing PPE.',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4',
    zone: [0.0, 0.0, 1.0, 1.0],
    tags: ['INDUSTRIAL_SAFETY', 'Hazard Zones', 'Worker Safety'],
  },
  {
    id: 'facility_security',
    title: 'Facility & Perimeter Security',
    subtitle: 'After-Hours Intrusion & Prohibited Items',
    description: 'Perimeter monitoring detecting unauthorized human intrusion, scaling fences, and unattended objects.',
    videoUrl: 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4',
    zone: [0.0, 0.0, 1.0, 1.0],
    tags: ['FACILITY_SECURITY', 'Perimeter Breach', 'Prohibited Items'],
  },
];
